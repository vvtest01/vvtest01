...
var gangnam = new naver.maps.Marker({
    ...
    intersectNotice: true,
        intersectNoticeTemplate: '<div style="width:180px;border:solid 1px #333;background-color:#fff;padding:5px;"><em style="font-weight:bold;color:#f00;">1</em>개의 마커가 있습니다.</div>'
});
...
var gangnamContent = [
        ...
        '   <div class="row">',
        '       <div class="col-md-2">',
        '           <strong style="float: right;">주소</strong>',
        '       </div>',
        '       <div class="col-md-10">',
        ...
        '   <div class="row">',
        '       <div class="col-md-2">',
        '           <strong style="float: right;">측정항목</strong>',
        '       </div>',
        '       <div class="col-md-10">',
        '           <p>PM10 PM2.5</p>',
        '       </div>',
